...
#畫布截圖比對
def canvas_compare(sample, case,name):
    ...
    print(str(name)+"所有點的數量: ", allpoint, " / menu有誤差的點數量: ", errorCount, " / menu誤差率: ",float(errorCount/allpoint))
    if errorCount / allpoint < 0.005:  #預估錯誤比例不可多於10%，超過即回傳False
        #print("Pass")
        return True
    else:
        #print("Failed")
